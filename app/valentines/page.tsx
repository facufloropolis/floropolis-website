        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex gap-6 justify-center items-center">
            <a
              ...
              onClick={() => pushEvent(CTA_EVENTS.footer_instagram_click, { cta_location: "valentines_page" })}
            >
            ...
            <a
              ...
              onClick={() => pushEvent(CTA_EVENTS.footer_tiktok_click, { cta_location: "valentines_page" })}
            >
