      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        {new Date() < new Date("2026-05-04T23:59:59-04:00") && (
          <div className="mb-8 rounded-xl border border-rose-200 bg-rose-50 px-5 py-4 text-center">
            ...
            <p className="text-xs text-rose-500 mt-0.5">Pre-order by May 4 for guaranteed May 10 delivery. Farm-direct pricing, delivery included.</p>
        ...
        <div className="text-center border-t border-slate-200 pt-10">
          ...
          {/* EXP-097: WA escape hatch */}
          <p className="mt-4 text-slate-500 text-sm">
            Prefer to chat first?{" "}
            <a
              href="https://wa.me/17869308463?text=Hi!%20I%27m%20interested%20in%20wholesale%20combo%20boxes%20from%20Floropolis."
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => pushEvent("whatsapp_click", { cta_location: "combo_boxes_cta" })}
