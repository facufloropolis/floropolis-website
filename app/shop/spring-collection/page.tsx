      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="text-center border-t border-slate-200 pt-10 mb-12">
          ...
          <p className="mt-4 text-slate-500 text-sm">
            ...
            <a
              href="https://wa.me/16452405203?text=Hi!%20I%27m%20interested%20in%20spring%20flowers%20from%20Floropolis."
              target="_blank"
    ...
    <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden hover:shadow-xl transition-all flex flex-col">
      <div className="aspect-square relative bg-slate-100">
        ...
        {product.badge === "EXCLUSIVE" && (
          <span className="absolute top-3 left-3 bg-slate-800 text-white text-xs font-semibold tracking-wide px-3 py-1.5 rounded shadow">
            Direct from Ecuador
          </span>
        )}
      </div>
