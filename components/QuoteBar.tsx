"use client";
// QuoteBar — EXP-055+068+080+NEW_SHARE | 2026-04-01 | Job_PM
// Sticky bottom bar: appears when cart has items, drives shop→quote submission
// EXP-068: WhatsApp secondary CTA
// EXP-NEW: Share cart URL — encodes cart as base64 JSON in ?cart= param

import { useState, useEffect } from "react";
import { useRouter } from "next/navigation";
import { getCartItems, getSubtotal } from "@/lib/quote-cart";
import { ShoppingCart, Share2, X, Copy, Check } from "lucide-react";
    ...
    <>
      <div className="fixed bottom-0 left-0 right-0 z-40 pb-safe">
        <div className="bg-emerald-600 text-white px-4 py-3 flex items-center justify-between gap-3 max-w-screen-xl mx-auto">
          ...
          {/* EXP-068+NEW: Three paths — share, WhatsApp, or form */}
