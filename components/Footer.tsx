        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400">
              ...
              <li>
                <a href="https://wa.me/16452405203" className="hover:text-emerald-400 transition-colors duration-200 flex items-center gap-2">
              ...
              <li>
                <a href="https://www.instagram.com/floropolisdirect" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition-colors duration-200 flex items-center gap-2">
              ...
              <li>
                <a href="https://www.tiktok.com/@floropolisdirect" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition-colors duration-200 flex items-center gap-2">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
