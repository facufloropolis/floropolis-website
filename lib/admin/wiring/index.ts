...
export const ADMIN_WIRING: WiringPageEntry[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'filter-form', level: 'LIVE', note: 'Multi-dimension filter form (vendor/source/category/visibility/GPM/flags). Export CSV button in the form footer streams /api/admin/catalog/export. Chip row removed in r3-cleanup per mockup parity.' },
